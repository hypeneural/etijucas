...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('require-tenant')->group(function () {
        ...
        Route::middleware('auth:sanctum')->group(function () {
            ...
            // User City Profile Routes (per-city local profiles)
            Route::prefix('user/city-profile')->group(function () {
                Route::get('/', [\App\Http\Controllers\Api\V1\UserCityProfileController::class, 'current']);
                Route::get('/{cityId}', [\App\Http\Controllers\Api\V1\UserCityProfileController::class, 'show']);
                Route::patch('/', [\App\Http\Controllers\Api\V1\UserCityProfileController::class, 'upsert']);
            });
