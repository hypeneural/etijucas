...
define(['./workbox-e610722b'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    ...
    plugins: [new workbox.BackgroundSyncPlugin("etijucas-sync-queue", {
      maxRetentionTime: 1440
    })]
  }), 'GET');
  workbox.registerRoute(/^\/fonts\/.*\.(ttf|woff2)$/i, new workbox.CacheFirst({
